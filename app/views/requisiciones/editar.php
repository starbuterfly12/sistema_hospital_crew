...
<body>
    ...
    <h1>Editar requisición <?= htmlspecialchars($requisicion['numero_requisicion_sistema'] ?? '', ENT_QUOTES, 'UTF-8') ?></h1>

    <form method="POST" id="form-requisicion" action="index.php?modulo=requisiciones&accion=editar&id=<?= (int) ($requisicion['id_requisicion'] ?? 0) ?>">
        <?= csrfField() ?>
        ...
        <p>Puede agregar o quitar requisiciones (número y fecha del papel elaborado por el servicio).</p>
        ...
        <p>Los bienes que ya pertenecen a esta requisición aparecen marcados; desmarque para quitarlos.</p>
        ...
        <div>
            ...
            <a href="index.php?modulo=requisiciones&accion=ver&id=<?= (int) ($requisicion['id_requisicion'] ?? 0) ?>">Cancelar</a>
        </div>
    </form>
