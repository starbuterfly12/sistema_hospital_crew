<?php
// Fragmento de contenido: se renderiza dentro de layouts/main.php (ver RequisicionesController::editar()).
...
// repetibles tampoco llevan class="form-control" a propósito (ver nota en crear.php); el <style>
// local las viste por selector para que server y JS produzcan filas idénticas.
...
<div class="page-header">
    <div class="page-header-fila">
        <div>
            <h1 class="page-title">Editar requisición <?= htmlspecialchars($requisicion['numero_requisicion_sistema'] ?? '', ENT_QUOTES, 'UTF-8') ?></h1>
            <p class="page-subtitle">Modifique la solicitud de bienes institucionales.</p>
        </div>

        <div class="page-actions">
            <a href="index.php?modulo=requisiciones&accion=ver&id=<?= $idRequisicion ?>" class="btn btn-secondary">Volver</a>
        </div>
    </div>
</div>
...
<form method="POST" id="form-requisicion" class="form-card" action="index.php?modulo=requisiciones&accion=editar&id=<?= $idRequisicion ?>">
    <?= csrfField() ?>
    ...
    <div class="form-section">
        ...
        <p class="form-hint">Los bienes que ya pertenecen a esta requisición aparecen marcados; desmarque para quitarlos.</p>
    ...
    <div class="form-actions">
        ...
        <a href="index.php?modulo=requisiciones&accion=ver&id=<?= $idRequisicion ?>" class="btn btn-secondary">Cancelar</a>
    </div>
</form>
