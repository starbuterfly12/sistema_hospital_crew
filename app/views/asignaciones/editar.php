...
<body>
    ...
    <p><strong>Número de asignación:</strong> <?= htmlspecialchars($asignacion['numero_asignacion'] ?? '', ENT_QUOTES, 'UTF-8') ?></p>
    <p><strong>Estado:</strong> <?= htmlspecialchars($asignacion['estado_asignacion'] ?? '', ENT_QUOTES, 'UTF-8') ?></p>
    ...
    <form method="POST">
        ...
        <div>
            ...
            <select id="id_responsable" name="id_responsable" required>
                ...
                <?php foreach ($responsables as $responsable): ?>
                    ...
                    ><?= htmlspecialchars($responsable['nombre_completo'] . (!empty($responsable['es_inactivo']) ? ' (Inactivo)' : ''), ENT_QUOTES, 'UTF-8') ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div>
            ...
            <a href="index.php?modulo=asignaciones&accion=ver&id=<?= (int) ($asignacion['id_asignacion'] ?? 0) ?>">Cancelar</a>
        </div>
    </form>
