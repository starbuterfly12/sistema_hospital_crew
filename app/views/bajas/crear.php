...
<body>
    ...
    <form method="POST" enctype="multipart/form-data" id="form-baja">
        ...
        <div>
            ...
            <?php if (empty($bodegas)): ?>
                <p><strong>No hay ninguna Bodega activa configurada. No es posible registrar una baja.</strong></p>
            <?php endif; ?>
        </div>

        <div>
            <p>Auxiliar de Inventarios: <strong><?= htmlspecialchars($nombreAuxiliarActual, ENT_QUOTES, 'UTF-8') ?></strong> (usuario que registra esta solicitud).</p>
        </div>
        ...
        <div id="contenedor-bienes">
            <p>Seleccione primero un responsable del área para ver sus bienes cargados actualmente.</p>
        </div>
        ...
        <div>
            <button type="submit">Enviar solicitud de baja</button>
            <a href="index.php?modulo=bajas">Cancelar</a>
        </div>
    </form>
    ...
    <script>
        ...
        (function () {
            ...
            var formulario = document.getElementById('form-baja');
            ...
            function renderizarBienes() {
                ...
                bienes.forEach(function (bien) {
                    ...
                    html += '<div class="bloque-bien">'
                        ...
                        + '<label>Imagen (opcional, JPG o PNG)<input type="file" name="imagen_bien[' + bien.id_bien + ']" accept=".jpg,.jpeg,.png"></label>'
                        + '</div>'
                        + '</div>';
                });
            ...
            formulario.addEventListener('submit', function (evento) {
                if (!confirm('¿Está seguro de enviar esta solicitud de baja?')) {
